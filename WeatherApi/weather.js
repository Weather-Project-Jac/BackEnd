...
async function getWeather(location, countryDate, stateCode, startDate, endDate) {
  ...
  const urlWeather = "https://api.open-meteo.com/v1/forecast?latitude="+ lat +"&longitude="+long+"&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,weather_code,wind_speed_10m,temperature_80m&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=Europe%2FBerlin&start_date="+ startD +"&end_date="+ endD +"&time_mode=time_interval"
