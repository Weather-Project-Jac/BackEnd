...
async function getWeather(location, countryDate = undefined, stateCode = undefined, startDate = undefined, endDate = undefined) {
  ...
  const urlWeather = "https://api.open-meteo.com/v1/forecast?latitude=" + lat + "&longitude=" + long + "&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,wind_speed_10m,temperature_80m&daily=temperature_2m_max,weather_code&daily=weather_code,temperature_2m_min&timezone=Europe%2FBerlin&start_date=" + startD + "&end_date=" + endD
